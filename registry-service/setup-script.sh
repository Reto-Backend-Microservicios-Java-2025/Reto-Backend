...
echo "🔧 Configurando proyecto para deployment en Azure..."
...
if [ -f "deploy-app-service-script.sh" ]; then
    chmod +x deploy-app-service-script.sh
    echo "✅ deploy-app-service-script.sh es ejecutable"
fi

echo ""
echo "🎉 Configuración completada. Ahora puedes:"
echo "   1. Ejecutar: ./deploy-app-service.sh (para deployment manual)"
echo "   2. Hacer push a GitHub (si configuraste GitHub Actions)"
echo ""
echo "📋 Archivos creados/configurados:"
echo "   - Dockerfile"
echo "   - .dockerignore"
echo "   - deploy-app-service-script.sh (ejecutable)"